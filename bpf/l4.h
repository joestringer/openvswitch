...
l4_ingress_policy(struct __sk_buff *skb OVS_UNUSED, __u16 dport OVS_UNUSED,
		  __u8 nexthdr OVS_UNUSED)
{
#ifdef CFG_L4_INGRESS
 ...
 */
static inline int __inline__
l4_egress_policy(struct __sk_buff *skb OVS_UNUSED, __u16 dport OVS_UNUSED,
		 __u8 nexthdr OVS_UNUSED)
{
#ifdef CFG_L4_EGRESS
